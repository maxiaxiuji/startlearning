...
def ssh_connect(argv_handler_item,host_to_user_obj):
    ...
    try:
        ...
        chan.blj_account=argv_handler_item.user
        chan.host_to_user_obj=host_to_user_obj
        chan.models=argv_handler_item.models


        print('*** Here we go!\n')
        """创建日志"""
        argv_handler_item.models.AuditLog.objects.create(
            user=argv_handler_item.user
            ,log_type =0,
